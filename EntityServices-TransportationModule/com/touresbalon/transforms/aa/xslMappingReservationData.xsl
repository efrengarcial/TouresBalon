...
<!-- @generated mapFile="com/touresbalon/transforms/aa/xslMappingReservationData.map" md5sum="c48ef20779235bc1f674a8611c9f4369" version="7.0.500" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    <body>
      ...
      <out:bookingFlight>
        <out:informacionReserva>
          <!-- a simple data mapping: "in4:makeReservation/in4:request/identificacion"(string) to "out:Identificacion"(string) -->
          ...
          <!-- a simple data mapping: "in4:makeReservation/in4:request/nombre"(string) to "out:Nombre"(string) -->
          <xsl:if test="in4:makeReservation/in4:request/nombre">
            <out:Nombre>
              <xsl:value-of select="in4:makeReservation/in4:request/nombre"/>
            </out:Nombre>
          </xsl:if>
          <!-- a simple data mapping: "in4:makeReservation/in4:request/apellido"(string) to "out:Apellido"(string) -->
          <xsl:if test="in4:makeReservation/in4:request/apellido">
            <out:Apellido>
              <xsl:value-of select="in4:makeReservation/in4:request/apellido"/>
            </out:Apellido>
          </xsl:if>
          <!-- a simple data mapping: "in4:makeReservation/in4:request/numeroViaje"(string) to "out:NumeroVuelo"(string) -->
          <xsl:if test="in4:makeReservation/in4:request/numeroViaje">
            <out:NumeroVuelo>
              <xsl:value-of select="in4:makeReservation/in4:request/numeroViaje"/>
            </out:NumeroVuelo>
          </xsl:if>
          <!-- a simple data mapping: "in4:makeReservation/in4:request/codigoCiudadOrigen"(string) to "out:CodigoCiudadOrigen"(string) -->
          ...
          <!-- a simple data mapping: "in4:makeReservation/in4:request/codigoCiudadDestino"(string) to "out:CodigoCiudadDestino"(string) -->
          ...
          <!-- a simple data mapping: "in4:makeReservation/in4:request/numeroSilla"(string) to "out:NumeroSilla"(string) -->
          <xsl:if test="in4:makeReservation/in4:request/numeroSilla">
            <out:NumeroSilla>
              <xsl:value-of select="in4:makeReservation/in4:request/numeroSilla"/>
            </out:NumeroSilla>
          </xsl:if>
          <!-- a simple data mapping: "in4:makeReservation/in4:request/fechaSalida"(dateTime) to "out:FechaSalida"(dateTime) -->
          <out:FechaSalida>
            <xsl:value-of select="in4:makeReservation/in4:request/fechaSalida"/>
          </out:FechaSalida>
          <!-- a simple data mapping: "in4:makeReservation/in4:request/orderID"(string) to "out:OrderID"(string) -->
  ...
  <xsl:template name="map:xslMappingReservationData2">
    ...
    <out:bookingFlight>
      <out:informacionReserva>
        <!-- a simple data mapping: "$body/in4:makeReservation/in4:request/identificacion"(string) to "out:Identificacion"(string) -->
        ...
        <!-- a simple data mapping: "$body/in4:makeReservation/in4:request/nombre"(string) to "out:Nombre"(string) -->
        <xsl:if test="$body/in4:makeReservation/in4:request/nombre">
          <out:Nombre>
            <xsl:value-of select="$body/in4:makeReservation/in4:request/nombre"/>
          </out:Nombre>
        </xsl:if>
        <!-- a simple data mapping: "$body/in4:makeReservation/in4:request/apellido"(string) to "out:Apellido"(string) -->
        ...
        <!-- a simple data mapping: "$body/in4:makeReservation/in4:request/numeroViaje"(string) to "out:NumeroVuelo"(string) -->
        ...
        <!-- a simple data mapping: "$body/in4:makeReservation/in4:request/codigoCiudadOrigen"(string) to "out:CodigoCiudadOrigen"(string) -->
        ...
        <!-- a simple data mapping: "$body/in4:makeReservation/in4:request/codigoCiudadDestino"(string) to "out:CodigoCiudadDestino"(string) -->
        ...
        <!-- a simple data mapping: "$body/in4:makeReservation/in4:request/numeroSilla"(string) to "out:NumeroSilla"(string) -->
        ...
        <!-- a simple data mapping: "$body/in4:makeReservation/in4:request/fechaSalida"(dateTime) to "out:FechaSalida"(dateTime) -->
        <out:FechaSalida>
          <xsl:value-of select="$body/in4:makeReservation/in4:request/fechaSalida"/>
        </out:FechaSalida>
        <!-- a simple data mapping: "$body/in4:makeReservation/in4:request/orderID"(string) to "out:OrderID"(string) -->
